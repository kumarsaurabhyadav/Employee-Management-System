...
const PasswordExpiredModal = ({ open, onClose }) => {
    const { setPasswordExpired } = useAuth()
            ...
            >
                ...
                <div className='flex items-center justify-between px-6 py-5 border-b border-zinc-100 bg-white relative z-10'>
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className='text-lg font-bold text-zinc-900 tracking-tight'>Password Expired</h2>
                    </div>
                </div>
                ...
                <div className='p-6 space-y-6 bg-white'>
                    <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl">
                        <p className="text-sm text-amber-800">
                            Your password has expired. Please update your password to continue using the system.
                        </p>
                    </div>
