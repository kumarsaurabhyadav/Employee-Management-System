    ...
    return (
        <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
            ...
            <div className='card p-5 sm:p-6'>
                <h3 className='font-medium mb-6 pb-4 border-b border-s-amber-100'>Personal Information</h3>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    <div>
                        ...
                        <input type='number' name='allowances' required
                            min='0' step='0.01' defaultValue={initialData?.allowances ?? 0} />
                    </div>

                    <div>
                        <label className='block mb-2 '>Deductions</label>
                        <input type='number' name='deductions' required
                            min='0' step='0.01' defaultValue={initialData?.deductions ?? 0} />
                    </div>
            ...
            {/* account setup */}
                <div className='card p-5 sm:p-6'>
                <h3 className=' text-base font-medium text-slate-900 mb-6 pb-4'>Account Setup</h3>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    <div className='sm:col-span-2'>
